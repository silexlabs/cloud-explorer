...
class FileTools {
	 ...
	 */
	static public inline function mimeTypeByExt() : StringMap<String> {
	...
	static public function getMimeType(filename : String) : Null<String> {

		var se : Int = filename.lastIndexOf('.');
