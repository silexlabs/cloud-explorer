...
angular.module('ceCtrls', ['ceServices'])
	 ...
	 */
	.controller('CEFileEntryCtrl', ['$scope', '$element', '$attrs', '$transclude', '$fileUpload', '$unifileSrv', function($scope, $element, $attrs, $transclude, $fileUpload, $unifileSrv)
		{
...
console.log("files from desktop case upload to: " + $scope.filePath);
					$fileUpload.upload( e.dataTransfer.files, $scope.filePath+'/' );
				}
				else // move case
				{
