...
angular.module('ceFileService', ['ngResource']).
	value( 'server.url', 'http://unifile.herokuapp.com/v1.0/' ).
	factory('ceFile', ['$resource', 'server.url', function($resource, serverUrl) {
		...
		return $resource( serverUrl + ':service/:method/:command/:path/ ', {}, {  // *very ugly* FIXME added space to keep the '/' at the end of the url
