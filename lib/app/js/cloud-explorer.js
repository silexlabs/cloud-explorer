	...
	.directive('ceBrowser',  function()
	{
		return {
			...
			template: "<div> \
						...
						<div ng-if=\"authPopup.show\" class=\"authPopup\"><div><a href=\"#\" ng-click=\"authorize()\">CLICK HERE</a> to authorize Cloud Explorer to use your {{ authPopup.srvName }} account.</div></div> \
						<div class=\"row-fluid\"> \
							<div class=\"span5\"> \
