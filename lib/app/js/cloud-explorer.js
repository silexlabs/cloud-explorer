	...
	.controller('CERightPaneCtrl', ['$scope', '$unifileSrv', '$ceUtils', function($scope, $unifileSrv, $ceUtils)
		{
			...
			*/
			$scope.checkIt = function(name, file)
			{
				...
				{
					$scope.checked.splice(indexOf, indexOf);
			...
			template: "<div> \
						...
						<ul ng-if=\"isConnected()\"> \
							<li class='controls clearfix'> \
								...
								<div ng-if='showCheckedOption()' class='checkedOption'> \
									<div ng-click='removeAllChecked()'>DELETE CHECKED</div> \
								</div> \
							</li> \
							...
							<li class=\"ce-item\" ng-repeat=\"file in files | orderBy:'is_dir':true\"> \
								...
								<label for='{{file.name}}'> \
									<div ng-if=\"file.is_dir && !renameOn\"> \
										<div class=\"ce-folder ce-file\" ng-class=\"getClass()\" ng-click=\"enterDir()\"> \
											{{file.name}} \
										</div> \
									</div> \
									<div ng-if=\"!file.is_dir && !renameOn\"> \
										<div class=\"ce-file\" ng-class=\"getClass()\" ng-click=\"select()\"> \
											{{file.name}} \
										</div> \
									</div> \
